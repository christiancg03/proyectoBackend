...
.navbar img.rounded-circle:hover {
  ...
  <!-- Bootstrap core CSS -->
  <link href="/GameNation/Usuarios/assets/css/bootstrap.min.css" rel="stylesheet">
  <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.0/css/all.min.css" rel="stylesheet">

  <!-- Custom styles for Game Nation -->
  <link href="/GameNation/Usuarios/assets/css/dashboard.css" rel="stylesheet">
  <link href="/GameNation/Usuarios/assets/css/404.css" rel="stylesheet">
</head>
<body>
  ...
  <a href="/GameNation/Usuarios/views/user/perfil.php" class="btn btn-sm btn-outline-info me-2">
